...
Verification.ledger = {}
Verification.maxEntries = 60
Verification.lastSignature = nil
...
function Verification:Format(entry)
    ...
    local lines = {
        ...
        "Candidate: " .. value(entry.candidateID, "UNBOUND"),
...
function Verification:LedgerReport()
    local lines = {
        ...
        "Version: " .. value(KWR.version),
        "Candidate: " .. value(KWR.BuildInfo and KWR.BuildInfo.candidateID, "UNBOUND"),
...
function Verification:OnEnable()
