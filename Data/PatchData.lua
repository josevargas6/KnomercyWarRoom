...
local PACKS = {
    ...
    ["12.1.0"] = {
        ...
        captured = "2026-09-23",
        officialHotfixReviewed = "2026-09-22",
        ...
        hotfixWatchlist = {
            ...
            affected = {
                ...
                "September 17: rating inflation increased for rated PvP, especially Blitz, RBG, and 3v3; this is not specialization strength evidence",
                "September 22: Unholy San'layn, Feral Druid of the Claw, Outlaw, Elemental, Enhancement, Affliction, and Arms received PvP offensive tuning; Assassination received a damage reduction",
                "September 22: Restoration Druid burst healing and instant control were reduced; directional tuning does not establish a team-composition tier",
            },
        },
        seasonPrepCorpus = {
            active = true,
        ...
        notes = {
            ...
            "The official ledger was reviewed through September 22, 2026. Recheck it immediately before a clean candidate build or field session.",
            "September 17 rating inflation changes ladder ratings, not relative spec performance; do not infer a ranking from it.",
            "September 22 class and PvP changes are advisory until measured Retail results support a bounded capability or composition rerank.",
