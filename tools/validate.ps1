...
foreach ($requiredTool in @(
    ...
    "client-build-preflight.ps1",
    "test-client-build-preflight.ps1",
    "fresh-replay-benchmark.ps1",
    "test-fresh-replay-benchmark.ps1",
    "test-decision-benchmark.ps1",
    "replay-discrepancy-report.ps1",
    "test-replay-discrepancy-report.ps1",
    "replay-contract-adjudication.ps1",
    "test-replay-contract-adjudication.ps1",
    "replay-contract-cluster-report.ps1",
    "test-replay-contract-cluster-report.ps1",
    "replay-contract-adjudication-review.ps1",
    "test-replay-contract-adjudication-review.ps1",
    "source-install-reconciliation.ps1",
    "test-source-install-reconciliation.ps1",
    "source-install-review-packet.ps1",
    "test-source-install-review-packet.ps1",
    "source-install-review-ledger.ps1",
    "test-source-install-review-ledger.ps1",
    "test-test-lua-receipt.ps1",
    "test-field-readiness-report.ps1",
