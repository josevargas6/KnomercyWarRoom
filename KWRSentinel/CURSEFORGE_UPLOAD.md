...
```text
<absolute path to certified KWR-Sentinel-6.1.1-alpha.29.zip>
```
...
- File: `KWR-Sentinel-6.1.1-alpha.29.zip`
- Display name: `KWR Sentinel 6.1.1-alpha.29`
- Release type: `Alpha`
...
- `KnomercyWarRoom-6.1.1-alpha.29.zip`
