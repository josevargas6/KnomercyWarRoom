...
```text
<absolute path to certified KWR-Sentinel-6.1.1-alpha.6.zip>
```
...
- File: `KWR-Sentinel-6.1.1-alpha.6.zip`
- Display name: `KWR Sentinel 6.1.1-alpha.6`
- Release type: `Alpha`
...
- `KnomercyWarRoom-6.1.1-alpha.6.zip`
