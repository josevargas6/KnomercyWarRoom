...
function MainWindow:BuildTacticalPage(page)
    ...
    mapCard.legend:SetText("|cff4f8cffBlue = team|r   |cffff3333Red = enemy|r   |cffffd05aGold = call / priority|r   |cffd7b25cSquares = objectives|r   |cff888888Trails = observed movement|r")
