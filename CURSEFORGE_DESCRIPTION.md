...
Version 6.1.0-alpha.14 adds battlefield truth contracts, monitored assignments,
...
validation, 242 deterministic checks, live enemy-token binding, reassessment
