...
Version 6.1.0-alpha.15 adds battlefield truth contracts, monitored assignments,
...
validation, 243 deterministic checks, live enemy-token binding, reassessment
