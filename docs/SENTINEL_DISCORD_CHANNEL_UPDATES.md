...
```text
KWR Sentinel 6.1.1-alpha.1 is the synchronized field-test execution-card
companion for Commander 6.1.1-alpha.1.

Do not post until the matching tag, public assets, CurseForge Alpha file, and
production readiness evidence are verified.

Download:
https://github.com/josevargas6/KnomercyWarRoom/releases/download/v6.1.1-alpha.1/KWR-Sentinel-6.1.1-alpha.1.zip

Release page:
https://github.com/josevargas6/KnomercyWarRoom/releases/tag/v6.1.1-alpha.1
...
```text
KWR Sentinel 6.1.1-alpha.1 field-test targets:
...
```text
KWR Sentinel 6.1.1-alpha.1 distribution receipt
...
SHA-256 manifest:
KWR_6_1_1_ALPHA_1_SHA256.txt on the GitHub release
