...
The `6.1.0-alpha.37` field-test copy applies to an active field-test release, not a
...
The `6.1.0-alpha.37` public copy applies to the optional Sentinel companion and
