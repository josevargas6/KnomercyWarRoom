...
The `6.1.0` stable release is the synchronized Season 2 Commander package.
...
The optional Sentinel companion ships as the synchronized `6.1.0` stable
release. It can receive Commander `KWRSync1` relays from another team member
