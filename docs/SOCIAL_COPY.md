...
The `6.1.1-alpha.10` field-test candidate is the synchronized Combat Focus Commander package.
...
The optional Sentinel companion ships as the synchronized `6.1.1-alpha.10`
