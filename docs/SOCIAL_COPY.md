...
The `6.1.1-alpha.4` field-test candidate is the synchronized Season 2 Commander package.
...
The optional Sentinel companion ships as the synchronized `6.1.1-alpha.4`
