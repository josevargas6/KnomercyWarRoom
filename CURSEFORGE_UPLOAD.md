...
```text
artifacts\KnomercyWarRoom-6.1.1-alpha.29.zip
```
...
- File: `KnomercyWarRoom-6.1.1-alpha.29.zip`
- Display name: `Knomercy War Room 6.1.1-alpha.29`
- Release type: `Alpha`
...
$artifact = "<absolute path to certified KnomercyWarRoom-6.1.1-alpha.29.zip>"
