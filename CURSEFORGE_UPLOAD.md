...
```text
artifacts\KnomercyWarRoom-6.1.1-alpha.5.zip
```
...
- File: `KnomercyWarRoom-6.1.1-alpha.5.zip`
- Display name: `Knomercy War Room 6.1.1-alpha.5`
- Release type: `Alpha`
...
$artifact = "<absolute path to certified KnomercyWarRoom-6.1.1-alpha.5.zip>"
